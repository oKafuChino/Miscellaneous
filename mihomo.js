function main(config) {
  ...
  config['proxy-groups'] = [
    ...
    { name: 'GLOBAL', type: 'select', icon: 'https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Global.png', 'include-all': true, proxies: ['选择代理', '手动选择', '静态资源', 'AI服务', '加密货币', '苹果服务', '谷歌服务', '微软服务', '哔哩哔哩', '巴哈姆特', 'Youtube', 'Netflix', 'TikTok', 'Spotify', 'Telegram', 'Twitter', '新浪微博', 'Truth Social', 'E-Hentai', 'PikPak网盘', '搜狗输入法', 'SSH', '自动选择', '故障转移', '直连', '广告拦截', ...regions] }
  ];
  ...
  config['rules'] = [
    ...
    'DOMAIN-SUFFIX,nodeseek.com,Truth Social',
    'DOMAIN-SUFFIX,seek.li,Truth Social',
    'DOMAIN-KEYWORD,nodeseek,Spotify',
